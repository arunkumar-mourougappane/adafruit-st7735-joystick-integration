...
PROJECT := Better_Adafruit_Joystick_Integration
...
OBJECTS += Adafruit_ST7735/Adafruit_ST7735.o
OBJECTS += main.o
...
INCLUDE_PATHS += -I../Adafruit_ST7735
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1587930779.755858
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1587930779.755858
...
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/0/07cde1d09495fdcb47d5326cd6c636c6/Better_Adafruit_Joystick_Integration/mbed_config.h
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -c
ASM_FLAGS += -Wall
